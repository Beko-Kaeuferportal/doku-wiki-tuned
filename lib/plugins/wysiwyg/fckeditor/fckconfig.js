...
FCKConfig.AutoGrowMax = 100000 ;
FCKConfig.AutoGrowMin = 150;
...
FCKConfig.ToolbarLocation = 'Out:wysiwyg_adobe_style_toolbar' ;
...
FCKConfig.ToolbarSets["dokuwiki"] = [
    ['FitWindow','-','Cut','Copy','Paste','PasteText','PasteWord','-','SpellCheck'],
    ...
    ['OrderedList','UnorderedList','Table','Rule'],
