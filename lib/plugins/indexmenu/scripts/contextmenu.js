...
indexmenu_contextmenu['all']['pg'] = {
    'view': [
        ['<span class="indexmenu_titlemenu"><b>Seite</b></span>'],
        ['Revisionen', 'indexmenu_getid(index.config.urlbase,id)+"do=revisions"'],
...
indexmenu_contextmenu['all']['ns'] = {
    'view': [
        ['<span class="indexmenu_titlemenu"><b>Namensraum</b></span>'],
        ['Suche...', '"javascript: indexmenu_srchpage(\'"+index.config.urlbase+"\',\'"+index.config.sepchar+"\',\'"+node.isdir+"\',\'"+node.dokuid+"\');"', 'Search for pages within this namespace']
    ]
};
...
if (JSINFO.isadmin) {
    ...
    indexmenu_contextmenu['pg'] = {
        'view': [
            ['Bearbeiten', 'indexmenu_getid(index.config.urlbase,id)+"do=edit"'],
            ['<em>Create--></em>', [
                ...
                ['Neue Seite', '"javascript: indexmenu_reqpage(\'"+index.config.urlbase+"\',\'"+index.config.sepchar+"\',\'"+node.dokuid+"\');"', 'Create a new page under this page']
            ]],
            ['<em>More--></em>', [
                ...
                ['toHTML', 'indexmenu_getid(index.config.urlbase,id)+"do=export_xhtml"'],
                ['toTXT', 'indexmenu_getid(index.config.urlbase,id)+"do=export_raw"']
            ]]
        ]
    };
    ...
    indexmenu_contextmenu['ns'] = {
        'view': [
            ['Neue Seite', '"javascript: indexmenu_reqpage(\'"+index.config.urlbase+"\',\'"+index.config.sepchar+"\',\'"+node.dokuid+"\');"', 'Create a new page inside this namespace'],
            ['<em>More--></em>', [
    ...
    indexmenu_contextmenu['pg'] = {
        'view': [
            ['Neue Seite', '"javascript: indexmenu_reqpage(\'"+index.config.urlbase+"\',\'"+index.config.sepchar+"\',\'"+node.dokuid+"\');"'],
            ['Bearbeiten', 'indexmenu_getid(index.config.urlbase,id)+"do=edit"', 1, 0 ],
            ['<em>More--></em>', [
...
function indexmenu_srchpage(u, s, isdir, nid) {
    var r = prompt("Suche in Namensraum", "");
    if (r) {
        var fnid = nid;
        if (isdir == "0") {
